...
export ARCH=arm64
export KBUILD_BUILD_USER="@Andy2660"
...
export BUILD_CROSS_COMPILE="${HOME}/toolchains/gcc/arm-gnu-toolchain-14.2.rel1-x86_64-aarch64-none-linux-gnu/bin/aarch64-linux-android-"
...
build_kernel(){
    ...
    make ${BUILD_OPTIONS} a82xq_kor_skt_defconfig custom.config
